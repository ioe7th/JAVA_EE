...
<![endif]-->
<title> 修改订单状态 - 黑盟</title>
<meta name="keywords" content="黑盟首创">
<meta name="description" content="中国矿业大学管理学院实验基地黑盟出品"></head></head>
<body>
<article class="page-container">
	<form action="${ctx}/bill/updateBill" method="post" class="form form-horizontal" id="billForm" name="fileForm" >
		<!-- 隐藏表单，flag表示添加标记 -->
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${bill.pno }"  id="pno" name="pno">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">商品名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${bill.pname}"  id="pname" name="pname">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">单价：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${bill.shop_price }"  id="price" name="price">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">订单状态：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${bill.state }"  id="state" name="state">
			</div>
		</div>
		<div class="row cl">
