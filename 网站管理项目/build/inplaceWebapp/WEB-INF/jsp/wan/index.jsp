...
<body>
    ...
    <div class="main-center">
        <div class="g-login-mid-outer">
            <div id="side">
                <ul class="m">
                    <li style="background-image: url(../images/banner01.jpg);"><a href="javascript:void(0)">
                    </a></li>
                    <li style="background-image: url(../images/banner02.jpg);"><a href="javascript:void(0)">
                    </a></li>
                    <li style="background-image: url(../images/banner03.jpg)"><a href="javascript:void(0)">
                    </a></li>
                    <li style="background-image: url(../images/banner04.jpg)"><a href="javascript:void(0)">
                    </a></li>
                </ul>
                <ul class="s">
                    <li class="cur">1</li>
