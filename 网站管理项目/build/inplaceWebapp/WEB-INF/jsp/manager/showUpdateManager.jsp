...
<article class="page-container">
	<form action="${ctx}/manager/updateManager" method="post" class="form form-horizontal" id="managerForm" name="fileForm" >
		<!-- 隐藏表单，flag表示添加标记 -->
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${manager.name }"  id="name" name="name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">用户密码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${manager.password }"  id="password" name="password">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">用户联系方式：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${manager.phone }"  id="phone" name="phone">
			</div>
		</div>
		<div class="row cl">
