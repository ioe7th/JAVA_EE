 ...
 * Generated at: 2017-07-26 12:36:39 UTC
...
public final class showAddProduct_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/page.tld", Long.valueOf(1501072543556L));
    _jspx_dependants.put("/WEB-INF/lib/jstl-1.2.jar", Long.valueOf(1496803445208L));
    _jspx_dependants.put("/WEB-INF/jsp/taglib.jsp", Long.valueOf(1501072543500L));
...
return;
    ...
    try {
      ...
      out.write("<![endif]-->\r\n");
      out.write("<title> 添加管理员 - 黑盟</title>\r\n");
      ...
      out.write("/product/addProduct\" method=\"post\" class=\"form form-horizontal\" id=\"managerForm\" name=\"fileForm\" >\r\n");
      ...
      out.write("\t\t\t\t<input type=\"text\" class=\"input-text\"   id=\"pname\" name=\"pname\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-3\">单价：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" class=\"input-text\"   id=\"shop_price\" name=\"shop_price\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-3\">存量：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" class=\"input-text\"   id=\"inventory\" name=\"inventory\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<div class=\"col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3\">\r\n");
      out.write("\t\t<input type=\"submit\"  class=\"btn btn-success radius\" id=\"btn\" value=\"添加 \">&nbsp;&nbsp;<input type=\"reset\" class=\"btn btn-success radius\" id=\"btn\" value=\"取消 \">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</form>\r\n");
      out.write("</article>\r\n");
      ...
      out.write("\t\tvar shop_price = $(\"#shop_price\");\r\n");
      out.write("\t\tvar inventory = $(\"#inventory\");\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar msg = \"\";\r\n");
      out.write("\t\tif ($.trim(pname.val()) == \"\"){\r\n");
      out.write("\t\t\tmsg = \"姓名不能为空！\";\r\n");
      out.write("\t\t\tpname.focus();\r\n");
      out.write("\t\t}else if ($.trim(shop_price.val()) == \"\"){\r\n");
      out.write("\t\t\tmsg = \"密码不能为空！\";\r\n");
      out.write("\t\t\tshop_price.focus();\r\n");
      out.write("\t\t}else if ($.trim(inventory.val()) == \"\"){\r\n");
      out.write("\t\t\tmsg = \"手机号不能为空！\";\r\n");
      out.write("\t\t\tinventory.focus();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tif (msg != \"\"){\r\n");
