...
<%@ page import="org.fkit.controller.mylistener"%>
			...
			<div class="topMessage">
				<div class="menu-hd">
					<a href="#" target="_top" class="h">亲，请登录</a> <a href="#"
						target="_top">免费注册</a> ${sessionScope.user.id}
					<%=mylistener.getCount() %>
				</div>
			</div>
		</ul>
	...
	<div class="listMain">
		...
		<div class="scoll">
			...
			<div class="flexslider">
				<ul class="slides">
					<li><img src="images/${SessionScope.product.image1 }"
						title="pic" /></li>
					<li><img src="images/${SessionScope.product.image2 }" /></li>
					<li><img src="images/${SessionScope.product.image3 }" /></li>
				</ul>
			</div>
			</section>
		</div>
		...
		<div class="item-inform">
			<div class="clearfixLeft" id="clearcontent">
				...
				<div class="box">
					...
					<div class="tb-booth tb-pic tb-s310">
						<a href="images/${sessionScope.product.image1 }"><img
							src="images/${sessionScope.product.image1 }" alt="细节展示放大镜特效"
							rel="images/${sessionScope.product.image1 }" class="jqzoom" /></a>
					</div>
					<ul class="tb-thumb" id="thumblist">
						<li class="tb-selected">
							<div class="tb-pic tb-s40">
								<a href="#"><img
									src="images/${sessionScope.product.image1 }"
									mid="images/${sessionScope.product.image1 }"
									big="images/${sessionScope.product.image1 }"></a>
							</div>
						</li>
						<li>
							<div class="tb-pic tb-s40">
								<a href="#"><img
									src="images/${sessionScope.product.image2 }"
									mid="images/${sessionScope.product.image2 }"
									big="images/${sessionScope.product.image2 }"></a>
							</div>
						</li>
						<li>
							<div class="tb-pic tb-s40">
								<a href="#"><img src="images/${sessionScope.product.image3}"
									mid="images/${sessionScope.product.image3 }"
									big="images/${sessionScope.product.image3 }"></a>
							</div>
						</li>
					</ul>
				</div>
			...
			<div class="clearfixRight">
				...
				<div class="tb-detail-hd">
					<h1>${sessionScope.product.pname }</h1>
				</div>
				<div class="tb-detail-list">
					...
					<div class="tb-detail-price">
						<li class="price iteminfo_price">
							<dt>促销价</dt>
							<dd>
								<em>¥</em><b class="sys_item_price">${sessionScope.product.shop_price }</b>
							</dd>
						</li>
					...
					<ul class="tm-ind-panel">
						<li class="tm-ind-item tm-ind-sellCount canClick">
							<div class="tm-indcon">
								<span class="tm-label">销量</span><span class="tm-count">${sessionScope.product.saleamount}</span>
							</div>
						</li>

						<li class="tm-ind-item tm-ind-reviewCount canClick tm-line3">
							<div class="tm-indcon">
								<span class="tm-label">库存</span><span class="tm-count">${sessionScope.product.inventory}</span>
							</div>
						</li>
					</ul>
					<div class="clear"></div>
								...
								<div class="theme-popbod dform">
									<form class="theme-signin" name="loginform" action=""
										...
										<input type="hidden" id="pid"
											value="${sessionScope.product.pid}"> <input
											type="hidden" id="uid" value="${sessionScope.user.id}">

										<input type="hidden" id="pname"
											value="${sessionScope.product.pname}"> <input
											type="hidden" id="price"
											value="${sessionScope.product.shop_price}"> <input
											type="hidden" id="image"
											value="${sessionScope.product.image1}">
									</form>
								</div>
							</div>
				...
				<div class="pay">
					...
					<li>
						<div class="clearfix tb-btn tb-btn-buy theme-login">
							<a id="LikBuy" title="点此按钮到下一步确认购买信息" onclick="buynow()" href="#">立即购买</a>
						</div>
					</li>
					<li>
						<div class="clearfix tb-btn tb-btn-basket theme-login">
							<a id="LikBasket" title="加入购物车" onclick="insertnow()" href="#"><i></i>加入购物车</a>
						</div>

					</li>
					<script type="text/javascript">
							     function buynow(){
							    	 var count =document.getElementById("text_box").value;
						...
						<div class="am-tab-panel am-fade am-in am-active">
							...
							<div class="details">
								...
								<div class="twlistNews">
									<img src="images/tw1.jpg" /> <img src="images/tw2.jpg" /> <img
										src="images/tw3.jpg" /> <img src="images/tw4.jpg" /> <img
										src="images/tw5.jpg" /> <img src="images/tw6.jpg" /> <img
										src="images/tw7.jpg" />
								</div>
							</div>
							<div class="clear"></div>
