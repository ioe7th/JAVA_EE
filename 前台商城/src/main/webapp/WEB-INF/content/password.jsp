...
<link href="<%=request.getContextPath()%>/css/personal.css"
	rel="stylesheet" type="text/css">
<link href="<%=request.getContextPath()%>/css/stepstyle.css"
	rel="stylesheet" type="text/css">

<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/jquery-1.7.2.min.js"></script>
<script
	src="<%=request.getContextPath()%>/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
		...
		<div class="am-container header">
			<ul class="message-l">
				<div class="topMessage">
					<div class="menu-hd">欢迎[${sessionScope.user.nickname }]</div>
				</div>
			</ul>
			<ul class="message-r">
				<div class="topMessage home">
					<div class="menu-hd">
						<a href="home1" target="_top" class="h">商城首页</a>
					</div>
				</div>
				...
				<div class="topMessage favorite">
					<div class="menu-hd">
						<a href="collection" target="_top"><i
	...
	<div class="center">
		<div class="col-main">
			<div class="main-wrap">
				...
				<form class="am-form am-form-horizontal" action="updatePassword"
					method="post">
					...
					<div class="am-form-group">
						...
						<div class="am-form-content">
							<input type="password" id="user-old-password" name="before"
					...
					<div class="am-form-group">
						...
						<div class="am-form-content">
							<input type="password" id="user-new-password" name="latter"
								placeholder="请设置密码">
						</div>
					</div>

					<div class="info-btn">
						<input class="am-btn am-btn-danger" type="submit" value="保留修改">
					</div>
		...
		<aside class="menu">
		<ul>
			<li class="person"><a href="index">个人中心</a></li>
