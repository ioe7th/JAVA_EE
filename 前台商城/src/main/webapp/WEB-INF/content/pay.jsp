						...
						<div class="bundle  bundle-last">
							<div class="bundle-main">
								<ul class="item-content clearfix">
											...
											<div class="item-info">
												<div class="item-basic-info">
													<a href="#" class="item-title J_MakePoint"
														data-point="tbcart.8.11">${sessionScope.bill.pname }</a>
												</div>
											</div>
										</li>
										<li class="td td-info">
										...
										<li class="td td-price">
											<div class="item-price price-promo-promo">
												<div class="price-content">
													<em class="J_Price price-now">${sessionScope.bill.shop_price }</em>
												</div>
											</div>
										</li>
									</div>
											...
											<div class="item-amount ">
												...
												<div class="sl">
													...
													<input class="text_box" name="" type="text"
														value="${sessionScope.bill.count }" style="width: 30px;" />
									...
									<li class="td td-sum">
										<div class="td-inner">
											<em tabindex="0" class="J_ItemSum number">${sessionScope.bill.total }</em>
										</div>
									</li>
					...
					<div class="pay-confirm clearfix">
						<div class="box">
							<div tabindex="0" id="holyshit267" class="realPay">
								<em class="t">实付款：</em> <span class="price g_price "> <span>¥</span>
									<em class="style-large-bold-red " id="J_ActualFee">${sessionScope.bill.total }</em>
								</span>
							</div>
						...
						<div id="holyshit269" class="submitOrder">
							<div class="go-btn-wrap">
								<a id="J_Go" href="docomment?pno=${sessionScope.bill.pno}"
									class="btn-go" tabindex="0" title="点击此按钮，提交订单">一键支付</a>
							</div>
						</div>
						<div class="clear"></div>
					</div>
