					...
					<div class="bundle-main">
						<c:forEach items="${sessionScope.cartItems}" var="cartItem">
							<ul class="item-content clearfix">
								...
								<li class="td td-item">
									<div class="item-pic">
										<a href="#" target="_blank" data-title="" class="J_MakePoint"
											...
											src="images/${cartItem.image }" class="itempic J_ItemImg"></a>
									</div>
									<div class="item-info">
										<div class="item-basic-info">
											<a href="#" target="_blank" title=""
												class="item-title J_MakePoint" data-point="tbcart.8.11">${cartItem.pname }</a>
										</div>
									</div>
								</li>
								<li class="td td-info">
								...
								<li class="td td-price">
									<div class="item-price price-promo-promo">
										<div class="price-content">
											...
											<div class="price-line">
												<em class="J_Price price-now" tabindex="0">${cartItem.shop_price }</em>
											</div>
										</div>
									</div>
								</li>
										...
										<div class="item-amount ">
											<div class="sl">
												...
												<input class="text_box" name="" type="text"
													value="${cartItem.count}" style="width: 30px;" /> <input
								...
								<li class="td td-sum">
									<div class="td-inner">
										<em tabindex="0" class="J_ItemSum number">${cartItem.subtotal}</em>
									</div>
								</li>
								<li class="td td-op">
									<div class="td-inner">
										<a title="移入收藏夹" class="btn-fav"
											href="collect?pid=${cartItem.pid}
											&pname=${cartItem.pname}&shop_price=${cartItem.shop_price}
											&image=${cartItem.image}&uid=${cartItem.uid}">
											移入收藏夹</a> <a
											href="remove?pid=${cartItem.pid }&uid=${cartItem.uid}"
											class="delete"> 删除</a>
									</div>
								</li>
							</ul>
						...
						<div class="float-bar-wrapper">
							...
							<div class="operations">
								<a href="#" hidefocus="true" class="deleteAll">删除</a> <a
									href="#" hidefocus="true" class="J_BatchFav">移入收藏夹</a>
							</div>
						...
						<div class="footer">
							...
							<div class="footer-bd">
								<p>
									...
									<a href="#">网站地图</a> <em>© 2015-2025 Hengwang.com 版权所有.
										更多模板 <a href="http://www.cssmoban.com/" target="_blank"
							...
							<form class="theme-signin" name="loginform" action=""
								...
								<div class="theme-signin-left">
									...
									<div class="theme-options">
										...
										<dd>
											<input class="min am-btn am-btn-default" name=""
												type="button" value="-" /> <input class="text_box" name=""
