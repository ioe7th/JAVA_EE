		...
		<div class="am-container header">
			<ul class="message-l">
				<div class="topMessage">
					<div class="menu-hd">
						欢迎[${sessionScope.user.nickname }] <a href="login" target="_top">退出登录</a>

						在线人数为：<%=mylistener.getCount() %>
					</div>
				</div>
			</ul>
			<ul class="message-r">
				...
				<div class="am-g am-g-fixed sale">
					<c:forEach items="${sessionScope.products}" var="product">
						<div class="am-u-sm-3 sale-item">
							<div class="s-img">
								<a href="# "><img src="images/${product.image1}" /></a>
							</div>
							<div class="s-info">
								<a href="#"><p class="s-title">${product.pname}</p></a>
								<div class="s-price">
									￥<b>${product.shop_price}</b> <a class="s-buy"
										href="detial?pid=${product.pid}">秒杀</a>
								</div>
							</div>
						</div>
					</c:forEach>
