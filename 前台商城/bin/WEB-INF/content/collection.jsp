			...
			<div class="main-wrap">
				...
				<div class="user-collection">
					...
					<div class="you-like">
						...
						<div class="s-content">
							<c:forEach items="${sessionScope.collections}" var="collect">
								<div class="s-item-wrap">
									<div class="s-item">

										<div class="s-pic">
											<a href="#" class="s-pic-link"> <img
												src="images/${collect.image }"
										...
										<div class="s-info">
											<div class="s-title">
												<a href="#" title="包邮s925纯银项链女吊坠短款锁骨链颈链日韩猫咪银饰简约夏配饰">${collect.pname }</a>
											</div>
											<div class="s-price-box">
												<span class="s-price"><em class="s-price-sign">¥</em><em
													class="s-value">42.50</em></span> <span class="s-history-price"><em
													class="s-price-sign">¥</em><em class="s-value">${collect.shop_price}</em></span>
											</div>
											<div class="s-extra-box">
												<a
													href="removecollect?pid=${collect.pid}&uid=${collect.uid}"
													class="c-nodo J_delFav_btn">取消收藏</a>
											</div>
										</div>
										<div class="s-tp">
